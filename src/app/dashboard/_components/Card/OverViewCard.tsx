"use client";
import useSubscribersAnalytics from "@/hooks/useGenerateAnalytics"
...
const DashboardOverViewCard = () => {
  ...
  const lastMonthSubscribers =
    !loading &&
    subscribersData?.last6Months[subscribersData?.last6Months?.length - 1];

  const previousLastMonthSubscribers =
    !loading &&
    subscribersData?.last6Months[subscribersData?.last6Months?.length - 2];
